...
func (r *ContainerRunner) ToSpec(ctx context.Context, params map[string]any) (*TaskSpec, error) {
...
func (r *ContainerRunner) ParseResult(result *TaskResult) (map[string]any, error) {
	if !result.Success {
	...
	// Otherwise try to parse output as JSON
	if result.Output != "" {
...
func (r *ProcessRunner) ToSpec(ctx context.Context, params map[string]any) (*TaskSpec, error) {
	env := make(map[string]string)
	for k, v := range params {
		switch val := v.(type) {
		case string:
...
func (r *ProcessRunner) ParseResult(result *TaskResult) (map[string]any, error) {
	if !result.Success {
...
func (r *HTTPRunner) ToSpec(ctx context.Context, params map[string]any) (*TaskSpec, error) {
...
func (r *HTTPRunner) ParseResult(result *TaskResult) (map[string]any, error) {
	if !result.Success {
...
func (r *InlineRunner) ToSpec(ctx context.Context, params map[string]any) (*TaskSpec, error) {
	return &TaskSpec{
		Type:  "inline",
		Input: params,
	}, nil
...
func (r *InlineRunner) ParseResult(result *TaskResult) (map[string]any, error) {
	if !result.Success {
...
func (r *InlineRunner) Execute(ctx context.Context, params map[string]any) (*TaskResult, error) {
