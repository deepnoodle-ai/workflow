...
// This is an internal interface used by path execution.
...
// This is an internal type used by Execution.
...
// This is an internal type used for branching.
...
// This is an internal type used for path-to-execution communication.
...
// This is an internal type used for join coordination.
...
// This is an internal type - use Execution as the public API.
type path struct {
	// Owned state
	id          string
	currentStep *Step
...
func (p *path) buildScriptGlobals() map[string]any {
	return map[string]any{
		"inputs": p.state.Inputs(),
		"state":  p.state.Variables(),
	}
}
