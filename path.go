...
type PathSpec struct {
	Step      *Step
	Variables map[string]any // State to copy to the new path
}
...
// StateCopy and related functions removed - replaced with PathLocalState for direct state access
